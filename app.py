    ...
    <section class="py-32 bg-[#f5f5f7]">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[800px]">
                ...
                <div class="md:col-span-3 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-10 text-white shadow-lg scale-reveal flex flex-col md:flex-row items-center justify-between"><div class="mb-6 md:mb-0"><h3 class="text-3xl font-bold">アイデア出しの壁打ち相手。</h3><p class="text-indigo-100 mt-2">設計課題のブレーンストーミングや、プレゼンの構成案まで。</p></div><button class="bg-white text-indigo-600 px-8 py-3 rounded-full font-bold hover:bg-opacity-90 transition shadow-lg">プロンプトを見る</button></div>
            </div>
        </div>
    </section>
